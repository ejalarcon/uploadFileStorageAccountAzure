...
public class UploadFileServlet extends HttpServlet {
	...
	String key = System.getProperty("upload.app.user") + ":" + System.getProperty("upload.app.pwd");
	...
	if (!allowUser(auth)) {
		...
		String accountName = System.getProperty("upload.app.accountName");
		String accountKey = System.getProperty("upload.app.accountKey");
